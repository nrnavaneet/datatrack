...
Issue and PR templates live under [`.github/`](https://github.com/nrnavaneet/datatrack/tree/main/.github). After cloning, `make test` and `make lint` mirror the CI pytest and pre-commit steps.
